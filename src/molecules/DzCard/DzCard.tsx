...
export const DzCard: FC<DzCardProps> = ({ type, data, onClickImage, imageStyles }) => {
  if (type === CARD_TYPES.MEDIA) {
    return <CardMedia data={data as CardMediaData} onClickImage={onClickImage} />;
  }
  if (type === CARD_TYPES.ARTWORK) {
    return <CardArtwork data={data as CardArtworkData} onClickImage={onClickImage} imageStyles={imageStyles} />;
  }
