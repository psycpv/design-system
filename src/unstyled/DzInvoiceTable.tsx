...
export interface DzInvoiceTableProps {
  projects: InvoiceProject[];
}

export const DzInvoiceTable: React.FunctionComponent<DzInvoiceTableProps> = ({
  projects,
}) => {
  return (
          ...
          <tfoot>
            ...
            <tr>
              <th
                scope="row"
                colSpan={3}
                className="hidden pl-6 pr-3 pt-4 text-right text-sm font-normal text-gray-500 sm:table-cell sm:pl-0"
              >
                Tax
              </th>
              <th
