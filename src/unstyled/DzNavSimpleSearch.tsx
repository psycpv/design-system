...
export interface DzNavSimpleSearchProps {
  user: NavUser;
...
export const DzNavSimpleSearch: React.FunctionComponent<DzNavSimpleSearchProps> = ({
  user,
  navigation,
  userNavigation,
}) => {
...
export default DzNavSimpleSearch;
